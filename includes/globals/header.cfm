...
<cfset errorEmail("mcmulleng@xavier.edu", "V4 Breadcrumb Error")>
<!doctype html>
<html class="no-js" lang="">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title><cfoutput>#( pageTitle NEQ "" ? "#pageTitle# | " : "" )#</cfoutput> Xavier University</title>
        ...
        <cfoutput>#loadStylesheets()#</cfoutput>
